...
int main ( ) {
    ...
    fprintf(fptr,"\nThe Fastest Swim Speed was %.2f mph in year %i. The Average Swim Speed was %.2f.",mSwim,ySwim,avgSwim);
    fprintf(fptr,"\nThe Fastest Bike Speed was %.2f mph in year %i. The Average Bike Speed was %.2f.",mBike,yBike,avgBike);
    fprintf(fptr,"\nThe Fastest Run Speed was %.2f mph in year %i. The Average Run Speed was %.2f.",mRun,yRun,avgRun);
    fprintf(fptr,"\nThe Fastest Overall Speed was %.2f mph in year %i. The Average Overal Speed was %.2f.",mTotal,yTotal,avgTotal);
