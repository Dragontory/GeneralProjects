...
public abstract class ProgramTest {
    ...
    /**
     * Test of parse on syntactically invalid input - The identifier at the end
     * of the program must be the same as the identifier at the beginning of the
     * program.
     */
    ...
    /**
     * Test of parse on syntactically invalid input - The identifier at the end
     * of each new instruction definition must be the same as the identifier at
    ...
    /**
     * Test of parse on syntactically invalid input - The name of each new
     * user-defined instruction must be unique, i.e., there cannot be two
     * user-defined instructions with the same name.
     */
    @Test(expected = AssertionError.class)
    ...
    /**
     * Test of parse on syntactically invalid input - The name of each new
     * user-defined instruction must not be the name of one of the primitive
     * instructions, i.e., move, turnleft, turnright, infect, or skip.
     */
    @Test(expected = AssertionError.class)
