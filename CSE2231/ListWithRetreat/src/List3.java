...
public class List3<T> extends ListSecondary<T> {
    ...
    private void createNewRep() {
        ...
        this.lastLeft = this.preStart; // index before leftLength
    ...
    public final void addRightFront(T x) {
        ...
        //New node data equals x
        newFront.data = x;

        //New node points next to old lastLeft + 1
        newFront.next = previousFront;

        //New node points previous to lastLeft
        newFront.previous = this.lastLeft;

        //Points lastLeft next to new node
    ...
    public final T removeRightFront() {
        ...
        // maintain previousFront.next.next points to new front node
        // new node points next to lastleft + 3 (old) or + 2 (after removal)
        // new front node data is lastleft + 2 data (same)

        Node previousFront = this.lastLeft.next;

        // last left point next to new front node
        this.lastLeft.next = this.lastLeft.next.next;

        // new front node points previous to last left
        this.lastLeft.next.previous = this.lastLeft;

        //Decrements rightLength
        this.rightLength--;
    ...
    public final void advance() {
        ...
        // shift left and right length accordingly
        this.leftLength++;
        this.rightLength--;
        this.lastLeft = this.lastLeft.next; // move where the 'gap' is
    ...
    public final void moveToStart() {
        ...
        this.leftLength = 0;
        this.lastLeft = this.preStart; // move gap back to beginning
    ...
    public final int leftLength() {
        ...
        assert this.conventionHolds();
        // nothing needs to be done besides return cause it is updated during each method
    ...
    public final void moveToFinish() {
        ...
        // update lengths of left and right
        this.leftLength += this.rightLength;
        this.rightLength = 0;

        // set the 'gap' between the left and right to the very end
    ...
    public final void retreat() {
        ...
        // set the 'gap' between the left and right to shift one to the left
